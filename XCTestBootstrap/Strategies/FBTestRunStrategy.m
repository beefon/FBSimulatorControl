...
- (FBFuture<NSNull *> *)execute
{
  ...
  for (NSString *path in self.configuration.additionalApplicationPaths) {
    FBBundleDescriptor *app = [FBApplicationBundle applicationWithPath:path error:&error];
    if (!app) {
...
- (FBFuture<NSNull *> *)startTestWithTestRunnerApp:(FBApplicationBundle *)testRunnerApp testTargetApp:(FBApplicationBundle *)testTargetApp additionalApplications:(NSArray<FBBundleDescriptor *> *)additionalApplications
{
